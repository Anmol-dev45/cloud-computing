...
const topics = {
  "Introduction to Cloud Computing": `<article>
...
`,
  "Cloud Deployment Models": `<article>
...
`,
  "Core Technologies in Cloud Computing": `<article>
...
`,
  "Cloud Computing Applications": `<article>
...
`,
  "Emerging Trends in Cloud Computing": `<article>
...
`,
  "Challenges and Future of Cloud Computing": `<article>
...
`,
  "Case Studies and Real-World Examples": `<article>
...
`,
  "Conclusion and Reflections": `<article>
...
// Populate sidebar with topics and add click event listeners
Object.keys(topics).forEach((key) => {
  let topicElement = document.createElement("div");
  topicElement.textContent = key;
